                    ...
                    <div class="card pt-4">
                        <div class="card-body">
                            <div class="text-center mb-5">
                                <img src="{{ asset('img/logo.png') }}" class='img-fluid mb-4' style="max-width:200px">
                                <h3>Login</h3>
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="clearfix">
                                    <button class="btn signin_btn black_colour" type="submit">Sign In</button>
                                </div>
                            </form>
                            <div class="mt-3">
